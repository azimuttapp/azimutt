module PagesComponents.Id_.Views.Erd.TableTest exposing (..)

import Expect
import Libs.Models.Platform as Platform
import PagesComponents.Id_.Models.CursorMode as CursorMode
import PagesComponents.Id_.Views.Erd.Table as Table
import Test exposing (Test, describe, test)


suite : Test
suite =
    describe "PagesComponents.Id_.Views.Erd.Table"
