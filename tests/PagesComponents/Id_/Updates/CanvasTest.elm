module PagesComponents.Id_.Updates.CanvasTest exposing (..)
...
import PagesComponents.Id_.Updates.Canvas exposing (computeFit, performZoom)
...
suite : Test
suite =
    describe "PagesComponents.Id_.Updates.Canvas"
