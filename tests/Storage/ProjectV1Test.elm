...
project0 =
    ...
    , name = "Project 0"
    , sources = Nel (ProjectSourceV1 "00000000-0000-0000-0000-000000000001" "source 1" (LocalFileV1 "structure.sql" 10000 (time 1102)) (time 1100) (time 1101)) []
...
project0Json =
    """{"id":"00000000-0000-0000-0000-000000000000","name":"Project 0","""
        ++ """"sources":[{"id":"00000000-0000-0000-0000-000000000001","name":"source 1","source":{"kind":"LocalFile","name":"structure.sql","size":10000,"lastModified":1102},"createdAt":1100,"updatedAt":1101}],"""
...
project1 =
    { id = "00000000-0000-0000-0000-000000000000"
    , name = "Project 0"
    , sources = Nel (ProjectSourceV1 "00000000-0000-0000-0000-000000000001" "source 1" (LocalFileV1 "structure.sql" 10000 (time 200)) (time 1100) (time 1101)) []
    , schema =
...
project1Json =
    """{"id":"00000000-0000-0000-0000-000000000000","name":"Project 0","""
        ++ """"sources":[{"id":"00000000-0000-0000-0000-000000000001","name":"source 1","source":{"kind":"LocalFile","name":"structure.sql","size":10000,"lastModified":200},"createdAt":1100,"updatedAt":1101}],"""
        ...
        { tables =
            Dict.fromListMap .id
                [ { id = ( "public", "users" )
                  ...
                  , checks = []
                  , comment = Nothing
                  , sources = [ SourceV1 "00000000-0000-0000-0000-000000000001" (Nel (SourceLineV1 10 "CREATE TABLE users") [ SourceLineV1 11 "  (id int NOT NULL, name varchar);" ]) ]
                  }
                , { id = ( "public", "creds" )
                  , schema = "public"
                  , name = "creds"
                  , columns =
                        Ned.buildMap .name
                            (ColumnV1 0 "user_id" "int" False Nothing Nothing [ SourceV1 "00000000-0000-0000-0000-000000000001" (Nel (SourceLineV1 14 "  user_id int NOT NULL,") []) ])
                            [ ColumnV1 1 "login" "varchar" False Nothing Nothing [ SourceV1 "00000000-0000-0000-0000-000000000001" (Nel (SourceLineV1 15 "  login varchar NOT NULL,") []) ]
                            , ColumnV1 2 "pass" "varchar" False Nothing (Just (CommentV1 "Encrypted field" [])) [ SourceV1 "00000000-0000-0000-0000-000000000001" (Nel (SourceLineV1 16 "  pass varchar NOT NULL,") []) ]
                            , ColumnV1 3 "role" "varchar" True (Just "guest") Nothing [ SourceV1 "00000000-0000-0000-0000-000000000001" (Nel (SourceLineV1 17 "  role varchar") []) ]
                            ]
                  , primaryKey = Nothing
                  ...
                  , sources =
                        [ SourceV1 "00000000-0000-0000-0000-000000000001"
...
project2Json =
    """{"id":"00000000-0000-0000-0000-000000000000","name":"Project 0","""
        ++ """"sources":[{"id":"00000000-0000-0000-0000-000000000001","name":"source 1","source":{"kind":"LocalFile","name":"structure.sql","size":10000,"lastModified":200},"createdAt":1100,"updatedAt":1101}],"""
        ++ """"schema":{"tables":["""
        ++ """{"schema":"public","table":"creds","columns":[{"name":"user_id","type":"int","sources":[{"id":"00000000-0000-0000-0000-000000000001","lines":[{"no":14,"text":"  user_id int NOT NULL,"}]}]},{"name":"login","type":"varchar","sources":[{"id":"00000000-0000-0000-0000-000000000001","lines":[{"no":15,"text":"  login varchar NOT NULL,"}]}]},{"name":"pass","type":"varchar","comment":{"text":"Encrypted field"},"sources":[{"id":"00000000-0000-0000-0000-000000000001","lines":[{"no":16,"text":"  pass varchar NOT NULL,"}]}]},{"name":"role","type":"varchar","nullable":true,"default":"guest","sources":[{"id":"00000000-0000-0000-0000-000000000001","lines":[{"no":17,"text":"  role varchar"}]}]}],"uniques":[{"name":"unique_login","columns":["login"],"definition":"(login)"}],"indexes":[{"name":"role_idx","columns":["role"],"definition":"(role)"}],"comment":{"text":"To allow users to login"},"sources":[{"id":"00000000-0000-0000-0000-000000000001","lines":[{"no":13,"text":"CREATE TABLE creds ("},{"no":14,"text":"  user_id int NOT NULL,"},{"no":15,"text":"  login varchar NOT NULL,"},{"no":16,"text":"  pass varchar NOT NULL,"},{"no":17,"text":"  role varchar"},{"no":18,"text":");"}]}]},"""
        ++ """{"schema":"public","table":"users","columns":[{"name":"id","type":"int"},{"name":"name","type":"varchar","nullable":true}],"primaryKey":{"name":"users_pk","columns":["id"]},"sources":[{"id":"00000000-0000-0000-0000-000000000001","lines":[{"no":10,"text":"CREATE TABLE users"},{"no":11,"text":"  (id int NOT NULL, name varchar);"}]}]}],"""
