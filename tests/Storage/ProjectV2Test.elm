...
project0 =
    ...
    , tables = Dict.empty
    , relations = []
    , layout = Layout (CanvasProps Position.zero Size.zero (Position 1 2) 0.75) [] [] (time 1200) (time 1201)
    , usedLayout = Nothing
    , layouts = Dict.empty
...
project1 =
    ...
    , tables = tables1
    , relations = []
    , layout = Layout (CanvasProps Position.zero Size.zero (Position 1 2) 0.75) [ TableProps ( "public", "users" ) (Position 3 4) Size.zero Color.red [ "id" ] True False ] [] (time 1200) (time 1201)
    , usedLayout = Nothing
    , layouts = Dict.fromList [ ( "empty", Layout (CanvasProps Position.zero Size.zero Position.zero 0.5) [] [] (time 1202) (time 1203) ) ]
...
project2 =
    ...
    , layouts =
        Dict.fromList
            [ ( "empty", Layout (CanvasProps Position.zero Size.zero Position.zero 0.5) [] [] (time 1202) (time 1203) )
            , ( "users", Layout (CanvasProps Position.zero Size.zero (Position 12 32) 1.5) [ TableProps ( "public", "users" ) (Position 90 102) Size.zero Color.red [ "id", "name" ] True False ] [] (time 1202) (time 1203) )
            ]
