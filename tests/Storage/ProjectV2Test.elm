...
project1 =
    ...
    , tables = tables1
    , relations = []
    , layout = Layout (CanvasProps (Position 1 2) 0.75) [ TableProps ( "public", "users" ) (Position 3 4) Color.red [ "id" ] True ] [] (time 1200) (time 1201)
    , usedLayout = Nothing
...
project2 =
    ...
    , layouts =
        Dict.fromList
            ...
            , ( "users", Layout (CanvasProps (Position 12 32) 1.5) [ TableProps ( "public", "users" ) (Position 90 102) Color.red [ "id", "name" ] True ] [] (time 1202) (time 1203) )
            ]
