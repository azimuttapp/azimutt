...
project0 =
    ...
    , notes = Dict.empty
    , usedLayout = "default"
    , layouts = Dict.fromList [ ( "default", Layout (CanvasProps (Position 10 20) 0.75) [] [] (time 1200) (time 1201) ) ]
...
project0Json =
    """{"id":"00000000-0000-0000-0000-000000000000","name":"Project 0","""
        ...
        ++ """"usedLayout":"default","layouts":{"default":{"canvas":{"position":{"left":10,"top":20},"zoom":0.75},"tables":[],"createdAt":1200,"updatedAt":1201}},"createdAt":1000,"updatedAt":1001,"version":2}"""
...
project1 =
    ...
    , layouts =
        Dict.fromList
            [ ( "default", Layout (CanvasProps (Position 10 20) 0.75) [ TableProps ( "public", "users" ) (Position 30 40) Size.zero Tw.red [ "id" ] True False False ] [] (time 1200) (time 1201) )
...
project1Json =
    """{"id":"00000000-0000-0000-0000-000000000000","name":"Project 0","""
        ...
        ++ """"usedLayout":"default","layouts":{"default":{"canvas":{"position":{"left":10,"top":20},"zoom":0.75},"tables":[{"id":"public.users","position":{"left":30,"top":40},"color":"red","columns":["id"],"selected":true}],"createdAt":1200,"updatedAt":1201},"empty":{"canvas":{"position":{"left":0,"top":0},"zoom":0.5},"tables":[],"createdAt":1202,"updatedAt":1203}},"""
...
project2Json =
    """{"id":"00000000-0000-0000-0000-000000000000","name":"Project 0","""
        ...
        ++ """"default":{"canvas":{"position":{"left":10,"top":20},"zoom":0.75},"tables":[{"id":"public.users","position":{"left":30,"top":40},"color":"red","columns":["id"],"selected":true}],"createdAt":1200,"updatedAt":1201},"""
