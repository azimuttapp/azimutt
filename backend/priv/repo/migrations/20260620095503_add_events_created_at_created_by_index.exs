defmodule Azimutt.Repo.Migrations.AddEventsCreatedAtCreatedByIndex do
  ...
  # if_not_exists so the index can be created by hand first (to fix prod immediately)
  # and this migration is then a safe no-op on the next deploy.
  def change do
    create index(:events, [:created_at, :created_by], concurrently: true, if_not_exists: true)
  end
end
