defmodule AzimuttWeb.Components.Icon do
  ...
  def x(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 flex-none fill-current stroke-current #{@class}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
