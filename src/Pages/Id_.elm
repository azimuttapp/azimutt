module Pages.Id_ exposing (Model, Msg, page)

import Conf
import Dict
import Gen.Params.Id_ exposing (Params)
import Gen.Route as Route
import Models.Project.ProjectId exposing (ProjectId)
import Models.ScreenProps as ScreenProps
import Page
import PagesComponents.Id_.Models as Models exposing (Msg)
import PagesComponents.Id_.Models.CursorMode as CursorMode
import PagesComponents.Id_.Models.ErdConf as ErdConf
...
page shared req =
    Page.element
        ...
        , view = Views.view (Request.pushRoute Route.Home_ req) req.url shared
...
init now id =
    ...
    , Cmd.batch
        [ Ports.setMeta
            ...
            , canonical = Just { route = Route.Id_ { id = id }, query = Dict.empty }
            , html = Just "h-full"
