...
slideover model content =
    ...
    div [ css [ Tw.fixed, Tw.inset_0, Tw.overflow_hidden, Tu.z_max, Tu.when (not model.isOpen) [ Tw.pointer_events_none ] ], ariaLabelledby labelId, role "dialog", ariaModal True ]
        [ div [ css [ Tw.absolute, Tw.inset_0, Tw.overflow_hidden ] ]
            [ div [ onClick model.onClickOverlay, css [ Tw.absolute, Tw.inset_0, Tw.bg_gray_500, Tw.bg_opacity_75, Tw.transition_opacity, Tw.ease_in_out, Tw.duration_500, B.cond model.isOpen Tw.opacity_100 Tw.opacity_0 ], ariaHidden True ] []
            , div [ css [ Tw.fixed, Tw.inset_y_0, Tw.right_0, Tw.pl_10, Tw.max_w_full, Tw.flex ] ]
                [ div [ css [ Tw.w_screen, Tw.max_w_md, Tw.transform, Tw.transition, Tw.ease_in_out, Tw.duration_500, Bp.sm [ Tw.duration_700 ], B.cond model.isOpen Tw.translate_x_0 Tw.translate_x_full ] ]
                    [ div [ css [ Tw.h_full, Tw.flex, Tw.flex_col, Tw.bg_white, Tw.shadow_xl, Tw.overflow_y_scroll ] ]
                        [ header labelId model.title model.onClickClose
                        , div [ css [ Tw.mb_6, Tw.relative, Tw.flex_1, Tw.px_4, Bp.sm [ Tw.px_6 ] ] ] [ content ]
                        ]
                    ]
                ]
            ]
