    ...
    div [ css [ bg_white ] ]
        [ div [ css [ max_w_4xl, mx_auto, py_16, px_4, lg [ max_w_7xl, px_8, flex, items_center, justify_between ], sm [ px_6, py_24 ] ] ]
            ...
            , div [ css [ mt_8, flex, lg [ mt_0, flex_shrink_0 ] ] ]
                [ a [ href (Route.toHref Route.App), track "footer-cta", css [ flex, items_center, justify_center, px_5, py_3, h_14, border, border_transparent, text_base, font_medium, rounded_md, shadow_sm, text_white, bg_gradient_to_r, from_green_600, to_indigo_600, hover [ text_white, from_green_700, to_indigo_700 ] ] ]
                    [ text "Explore now!" ]
