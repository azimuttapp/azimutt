        ...
        , div [ css [ "relative pt-6 pb-16", sm "pb-24" ] ]
            [ div []
                [ div [ css [ "max-w-7xl mx-auto px-4", sm "px-6" ] ]
                    [ nav [ css [ "relative flex items-center justify-between", md "justify-center", sm "h-10" ], ariaLabel "Global" ]
            ...
            , main_ [ css [ "mt-16 mx-auto max-w-7xl px-4", sm "mt-24" ] ]
                [ div [ css [ "text-center" ] ]
                    [ h1 [ css [ "text-4xl tracking-tight font-extrabold text-gray-900", md "text-6xl", sm "text-5xl" ] ]
                        [ span [ css [ "block", xl "inline" ] ]
                            [ text "Explore your " ]
                        , span [ css [ "block text-blue-600", xl "inline" ] ]
                            [ text "database schema" ]
                        ]
                    , p [ css [ "mt-3 max-w-md mx-auto text-base text-gray-500", md "mt-5 text-xl max-w-3xl", sm "text-lg" ] ]
                        [ text "Easily visualize your database schema and see how everything fits together." ]
                    , div [ css [ "mt-5 max-w-md mx-auto", md "mt-8", sm "flex justify-center" ] ]
...
backgroundImageSlice model =
    div [ css [ "relative" ] ]
        ...
        , div [ css [ "max-w-7xl mx-auto", lg "px-8", sm "px-6" ] ]
            [ div [ css [ "relative shadow-xl", sm "rounded-2xl overflow-hidden" ] ]
                ...
                , div [ css [ "relative px-4 py-16", lg "py-32 px-8", sm "px-6 py-24" ] ]
                    [ h1 [ css [ "text-4xl font-extrabold tracking-tight", lg "text-6xl", sm "text-5xl" ] ]
