...
rightLinksWhite model =
    rightLinks { bg = "bg-white", text = "text-gray-500 hover:text-gray-900" } model


rightLinksIndigo : RightLinksModel msg -> Html msg
rightLinksIndigo model =
    rightLinks { bg = "bg-indigo-600", text = "text-white hover:text-indigo-50" } model
...
leftLinksIndigo model =
    leftLinks { bg = "bg-indigo-600", links = "text-white hover:text-indigo-50", secondary = "text-white bg-indigo-500 hover:bg-opacity-75", primary = "text-indigo-600 bg-white hover:bg-indigo-50" } model


leftLinksWhite : LeftLinksModel -> Html msg
leftLinksWhite model =
    leftLinks { bg = "bg-white", links = "text-gray-500 hover:text-gray-900", secondary = "text-gray-500 hover:text-gray-900", primary = "text-white bg-indigo-600 hover:bg-indigo-700" } model
