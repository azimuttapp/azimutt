...
rightLinksWhite model =
    rightLinks { bg = Tw.bg_white, text = [ Tw.text_gray_500, Css.hover [ Tw.text_gray_900 ] ] } model


rightLinksIndigo : RightLinksModel msg -> Html msg
rightLinksIndigo model =
    rightLinks { bg = Tw.bg_indigo_600, text = [ Tw.text_white, Css.hover [ Tw.text_indigo_50 ] ] } model
...
leftLinksIndigo model =
    leftLinks { bg = Tw.bg_indigo_600, links = [ Tw.text_white, Css.hover [ Tw.text_indigo_50 ] ], secondary = [ Tw.text_white, Tw.bg_indigo_500, Css.hover [ Tw.bg_opacity_75 ] ], primary = [ Tw.text_indigo_600, Tw.bg_white, Css.hover [ Tw.bg_indigo_50 ] ] } model


leftLinksWhite : LeftLinksModel -> Html msg
leftLinksWhite model =
    leftLinks { bg = Tw.bg_white, links = [ Tw.text_gray_500, Css.hover [ Tw.text_gray_900 ] ], secondary = [ Tw.text_gray_500, Css.hover [ Tw.text_gray_900 ] ], primary = [ Tw.text_white, Tw.bg_indigo_600, Css.hover [ Tw.bg_indigo_700 ] ] } model
...
doc =
    Chapter.chapter "Header"
        |> Chapter.renderStatefulComponentList
            ...
            , ( "rightLinks", \_ -> rightLinks { bg = Tw.bg_white, text = [] } (rightLinksModel logoIndigo) )
            , ( "leftLinksIndigo", \_ -> leftLinksIndigo (leftLinksModel logoWhite) )
            , ( "leftLinksWhite", \_ -> leftLinksWhite (leftLinksModel logoIndigo) )
            , ( "leftLinks", \_ -> leftLinks { bg = Tw.bg_white, links = [], secondary = [], primary = [] } (leftLinksModel logoIndigo) )
            ]
