module PagesComponents.Home_.View exposing (viewProjects)
...
viewProjectCard zone project =
    li [ class "az-project", css [ "col-span-1 flex flex-col border border-gray-200 rounded-lg divide-y divide-gray-200", hover [ "shadow-lg" ] ] ]
        ...
        , div [ css [ "flex divide-x divide-gray-200" ] ]
            ...
            , a ([ href (Route.toHref (Route.Id_ { id = project.id })), css [ "flex-grow inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium", hover [ "text-gray-500" ] ] ] ++ track (Track.loadProject project))
