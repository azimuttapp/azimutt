...
viewApp model =
    List.concatMap identity
        ...
        , [ B.cond (model.viewMode == Graph) (viewGraph model.domInfos (model.project |> Maybe.map .schema)) (lazy6 viewErd model.hover model.cursorMode model.dragState model.selection model.domInfos (model.project |> Maybe.map .schema)) ]
