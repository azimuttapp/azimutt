...
viewHelpModal =
    bsModal conf.ids.helpModal
        ...
        , p [ class "mb-0" ]
            [ text "I hope you find Azimutt as much as useful as I am. The application is quickly evolving and any feedback, feature request or use case description is "
            , feedbackLink "very welcome"
...
feedbackLink value =
    extLink constants.azimuttFeedback value
