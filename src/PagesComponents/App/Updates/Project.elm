...
import Models.Project exposing (Project, ProjectId, ProjectName, ProjectSource, ProjectSourceContent(..), SampleName, decodeProject, extractPath)
...
import Ports exposing (activateTooltipsAndPopovers, click, dropProject, hideModal, observeTablesSize, saveProject, toastError, toastInfo, track, trackErrorList)
import Time
...
addToProject : Time.Posix -> ProjectId -> ProjectSource -> FileContent -> Maybe SampleName -> Model -> ( Model, Cmd Msg )
addToProject _ _ _ _ _ model =
    ( model, toastError "Not implemented" )
