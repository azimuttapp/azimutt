        ...
        [ div [ css [ bg_indigo_600, pb_32 ] ]
            [ nav [ css [ bg_indigo_600, border_b, border_indigo_300, border_opacity_25, lg [ border_none ] ] ]
                [ div [ css [ max_w_7xl, mx_auto, px_2, lg [ px_8 ], sm [ px_4 ] ] ]
                    [ div [ css [ relative, h_16, flex, items_center, justify_between, lg [ border_b, border_indigo_400, border_opacity_25 ] ] ]
                        [ div [ css [ px_2, flex, items_center, lg [ px_0 ] ] ]
                            ...
                            , div [ css [ hidden, lg [ block, ml_10 ] ] ] [ viewNavLinks navLinks currentPage ]
                            ]
                ...
                , {- Mobile menu, show/hide based on menu state. -}
                  div [ css [ lg [ hidden ] ], id "mobile-menu" ]
                    [ viewMobileNavLinks navLinks currentPage
            ...
            , header [ css [ py_10 ] ]
                [ div [ css [ max_w_7xl, mx_auto, px_4, lg [ px_8 ], sm [ px_6 ] ] ]
                    [ h1 [ css [ text_3xl, font_bold, text_white ] ] [ text "My projects" ]
                    ]
                ]
            ]
        , main_ [ css [ neg_mt_32 ] ]
...
viewNavLinks : List Link -> Maybe String -> Html msg
viewNavLinks links current =
    div [ css [ flex, space_x_4 ] ] (links |> List.map (viewLink [ text_sm ] current))


viewMobileNavLinks : List Link -> Maybe String -> Html msg
viewMobileNavLinks links current =
    div [ css [ px_2, pt_2, pb_3, space_y_1 ] ] (links |> List.map (viewLink [ block, text_base ] current))


viewLink : List Style -> Maybe String -> Link -> Html msg
viewLink styles current link =
    if current |> M.contains link.text then
