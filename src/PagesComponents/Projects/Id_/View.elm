...
viewLoader : Html msg
viewLoader =
    div [ css [ "tw-loader flex justify-center items-center h-screen" ] ]
        [ div [ css [ "animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-primary-500" ] ] []
        ]
...
viewToasts toasts =
    div [ css [ "tw-toasts" ] ] [ Toast.container toasts ToastHide ]
