...
import Html.Styled.Attributes exposing (alt, css, href, id, src, tabindex, type_)
            ...
            [ div [ css [ flex, justify_between, h_16 ] ]
                [ div [ css [ flex ] ]
                    [ div [ css [ flex_shrink_0, flex, items_center ] ]
                        [ img [ css [ block, h_8, w_auto, lg [ hidden ] ], src "https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg", alt "Workflow" ] []
                        , img [ css [ hidden, h_8, w_auto, lg [ block ] ], src "https://tailwindui.com/img/logos/workflow-logo-indigo-600-mark-gray-800-text.svg", alt "Workflow" ] []
                        ]
                      ...
                      div [ css [ ml_3, relative ] ]
                        [ div []
                            [ button [ type_ "button", css [ bg_white, flex, text_sm, rounded_full, focus [ outline_none, ring_2, ring_offset_2, ring_indigo_500 ] ], id "user-menu-button", ariaExpanded False, ariaHaspopup True ]
                                ...
                                , img [ css [ h_8, w_8, rounded_full ], src "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80", alt "" ] []
                                ]
                            ]
                        , {-
            ...
            , div [ css [ pt_4, pb_3, border_t, border_gray_200 ] ]
                [ div [ css [ flex, items_center, px_4 ] ]
                    [ div [ css [ flex_shrink_0 ] ]
                        [ img [ css [ h_10, w_10, rounded_full ], src "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80", alt "" ] []
                        ]
                    , div [ css [ ml_3 ] ]
