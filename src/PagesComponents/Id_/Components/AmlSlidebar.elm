module PagesComponents.Id_.Components.AmlSlidebar exposing (Model, setSource, update, view)
...
import PagesComponents.Id_.Models exposing (AmlSidebar, AmlSidebarMsg(..), Msg(..), simplePrompt)
