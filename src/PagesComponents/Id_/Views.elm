module PagesComponents.Id_.Views exposing (title, view)
...
import PagesComponents.Id_.Models exposing (ContextMenu, Model, Msg(..))
...
import PagesComponents.Id_.Views.Commands exposing (viewCommands)
import PagesComponents.Id_.Views.Erd as Erd exposing (viewErd)
import PagesComponents.Id_.Views.Modals.Confirm exposing (viewConfirm)
import PagesComponents.Id_.Views.Modals.CreateLayout exposing (viewCreateLayout)
import PagesComponents.Id_.Views.Modals.EditNotes exposing (viewEditNotes)
import PagesComponents.Id_.Views.Modals.FindPath exposing (viewFindPath)
import PagesComponents.Id_.Views.Modals.Help exposing (viewHelp)
import PagesComponents.Id_.Views.Modals.ProjectSettings exposing (viewProjectSettings)
import PagesComponents.Id_.Views.Modals.Prompt exposing (viewPrompt)
import PagesComponents.Id_.Views.Modals.SchemaAnalysis exposing (viewSchemaAnalysis)
import PagesComponents.Id_.Views.Modals.Sharing exposing (viewSharing)
import PagesComponents.Id_.Views.Modals.SourceParsing exposing (viewSourceParsing)
import PagesComponents.Id_.Views.Modals.SourceUpload exposing (viewSourceUpload)
import PagesComponents.Id_.Views.Navbar as Navbar exposing (viewNavbar)
import PagesComponents.Id_.Views.Watermark exposing (viewWatermark)
import Router
    ...
    NotFound.simple
        ...
        , links =
            (if conf.projectManagement then
                [ { url = Route.toHref Route.Home_, text = "Back to dashboard" } ]
