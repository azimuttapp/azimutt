module PagesComponents.Id_.Models.EmbedMode exposing (EmbedMode, EmbedModeId, advanced, all, default, frozen, full, layout, move, static)

import PagesComponents.Id_.Models.ErdConf exposing (ErdConf, embedDefault)
