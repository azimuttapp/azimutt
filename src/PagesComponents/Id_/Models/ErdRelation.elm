module PagesComponents.Id_.Models.ErdRelation exposing (ErdRelation, create, label, new, unpack)
...
import PagesComponents.Id_.Models.ErdColumnRef as ErdColumnRef exposing (ErdColumnRef)
