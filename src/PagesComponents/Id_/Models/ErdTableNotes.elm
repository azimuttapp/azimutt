module PagesComponents.Id_.Models.ErdTableNotes exposing (ErdTableNotes, createAll, empty, get, set, unpackAll)

import Dict exposing (Dict)
import Libs.Maybe as Maybe
import Models.Project.ColumnName exposing (ColumnName)
import Models.Project.TableId exposing (TableId)
import PagesComponents.Id_.Models.Notes as Notes exposing (Notes, NotesKey, NotesRef(..))
