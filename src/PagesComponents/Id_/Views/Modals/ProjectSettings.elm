module PagesComponents.Id_.Views.Modals.ProjectSettings exposing (viewProjectSettings)
...
import PagesComponents.Id_.Models exposing (Msg(..), ProjectSettingsDialog, ProjectSettingsMsg(..), confirm)
