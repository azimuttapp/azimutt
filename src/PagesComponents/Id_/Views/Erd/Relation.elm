module PagesComponents.Id_.Views.Erd.Relation exposing (ColumnInfo, buildColumnInfo, viewEmptyRelation, viewRelation, viewVirtualRelation)
...
import PagesComponents.Id_.Models exposing (Msg(..))
