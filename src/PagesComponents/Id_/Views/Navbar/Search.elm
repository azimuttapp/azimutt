module PagesComponents.Id_.Views.Navbar.Search exposing (viewNavbarSearch)
...
import PagesComponents.Id_.Models exposing (Msg(..), SearchModel, confirm)
...
import PagesComponents.Id_.Models.Notes exposing (Notes)
import Simple.Fuzzy
