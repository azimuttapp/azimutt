module PagesComponents.Id_.Updates.VirtualRelation exposing (Model, handleVirtualRelation)

import Libs.Models.Position as Position
import Libs.Task as T
import PagesComponents.Id_.Models exposing (Msg(..), VirtualRelation, VirtualRelationMsg(..))
