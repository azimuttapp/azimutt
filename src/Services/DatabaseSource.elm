module Services.DatabaseSource exposing (Model, Msg(..), Status(..), init, source, viewInput, viewParsing)
...
init : SchemaName -> Maybe Source -> Model
init defaultSchema src =
...
viewInput : HtmlId -> Model -> Html Msg
