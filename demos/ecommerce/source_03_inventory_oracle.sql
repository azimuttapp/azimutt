...
COMMENT ON COLUMN C##INVENTORY.PRODUCTS.WIDTH IS 'typical width of the product, see PRODUCT_VERSIONS for the real one';
COMMENT ON COLUMN C##INVENTORY.PRODUCTS.LENGTH IS 'typical length of the product, see PRODUCT_VERSIONS for the real one';
COMMENT ON COLUMN C##INVENTORY.PRODUCTS.HEIGHT IS 'typical height of the product, see PRODUCT_VERSIONS for the real one';
COMMENT ON COLUMN C##INVENTORY.PRODUCTS.WEIGHT IS 'typical weight of the product, see PRODUCT_VERSIONS for the real one';
