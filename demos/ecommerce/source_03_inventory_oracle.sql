...
CREATE TABLE C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (
    WAREHOUSE_ID NUMBER REFERENCES C##INVENTORY.WAREHOUSES (ID),
    EMPLOYEES_ID NUMBER REFERENCES C##INVENTORY.EMPLOYEES (ID),
    KIND         VARCHAR2(255),
    VALUE        VARCHAR2(255),
    EXPIRE       TIMESTAMP,
    CREATED_AT   TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 1, 'name', 'Harry Potter', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 1, 'badge', 'HP1234', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 1, 'cni', '01 23 45 678 901', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 2, 'badge', 'HG5678', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 2, 'cni', '02 34 56 789 012', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 3, 'badge', 'RW9101', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 3, 'cni', '03 45 67 890 123', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 4, 'badge', 'AD1213', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 4, 'cni', '04 56 78 901 234', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 5, 'badge', 'SS1415', NULL, 16);
INSERT INTO C##INVENTORY.WAREHOUSE_IDENTITY_PROOFS (WAREHOUSE_ID, EMPLOYEES_ID, KIND, VALUE, EXPIRE, CREATED_BY) VALUES (1, 5, 'cni', '05 67 89 012 345', NULL, 16);
...
INSERT INTO C##INVENTORY.INVENTORY_OBSERVATIONS (INVENTORY_ID, PHYSICAL_PRODUCT_ID, STATUS, MESSAGE, CREATED_BY, UPDATED_BY) VALUES (1, 1, 'missing', 'Item not found', 13, 13);
INSERT INTO C##INVENTORY.INVENTORY_OBSERVATIONS (INVENTORY_ID, PHYSICAL_PRODUCT_ID, STATUS, MESSAGE, CREATED_BY, UPDATED_BY) VALUES (1, 2, 'broken', 'Item damaged', 14, 14);
INSERT INTO C##INVENTORY.INVENTORY_OBSERVATIONS (INVENTORY_ID, PHYSICAL_PRODUCT_ID, STATUS, MESSAGE, CREATED_BY, UPDATED_BY) VALUES (1, 3, 'misplaced', 'Moved at the right place', 14, 14);
