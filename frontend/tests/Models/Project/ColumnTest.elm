...
suite =
    describe "Column"
        [ describe "serialization"
            [ testEncode "basic"
                Column.encode
                (Column 1 "id" "int" False Nothing Nothing Nothing Nothing Nothing)
                """{"name":"id","type":"int"}"""
            , testEncode "full"
                Column.encode
                (Column 1 "id" "int" True (Just "0") (Just (Comment "id col")) (Nel.fromList [ "a" ]) Nothing Nothing)
            ...
            , testEncode "nested"
                ...
                (Column 1
                    ...
                    Nothing
                    Nothing
                    ([ Column 0 "kind" "string" False Nothing Nothing Nothing Nothing Nothing
                     , Column 1 "value" "number" False Nothing Nothing Nothing Nothing Nothing
                     ]
                        |> Nel.fromList
