...
suite =
    describe "Libs.Models.DateTime"
        ...
        , describe "human"
            ...
            , test "minutes" (\_ -> "2023-08-03T18:21:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a few minutes ago")
            , test "hour" (\_ -> "2023-08-03T17:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "an hour ago")
            , test "hours" (\_ -> "2023-08-03T14:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a few hours ago")
            , test "day" (\_ -> "2023-08-02T18:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a day ago")
            , test "days" (\_ -> "2023-08-01T18:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a few days ago")
            , test "month" (\_ -> "2023-07-03T18:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a month ago")
            , test "months" (\_ -> "2023-03-03T18:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a few months ago")
            , test "year" (\_ -> "2022-08-03T18:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a year ago")
            , test "years" (\_ -> "2020-08-03T18:28:32.652Z" |> DateTime.unsafeParse |> DateTime.human now |> Expect.equal "a few years ago")
