...
""")
  ...
  (SELECT JSON_ARRAYAGG(JSON_OBJECT('id', s.`id`, 'details:id', s.`details`->>'$.id')) FROM `events` s WHERE s.`details`->>'$.created_by'='11bd9544-d56a-43d7-9065-6f1f25addf8a' LIMIT 20) AS `.events`
LIMIT 1;
""")
