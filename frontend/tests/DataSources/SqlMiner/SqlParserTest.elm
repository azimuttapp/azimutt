module DataSources.SqlMiner.SqlParserTest exposing (..)

import DataSources.SqlMiner.Parsers.AlterTable exposing (TableConstraint(..), TableUpdate(..))
import DataSources.SqlMiner.SqlParser exposing (Command(..), buildStatements, hasKeyword, parseCommand, splitLines)
