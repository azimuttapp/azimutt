...
project1 =
    ...
    , tableRowsSeq = 1
    , settings = ProjectSettings (FindPathSettings 4 "" "") defaultSchema [] False "" (HiddenColumns "created_.+, updated_.+" 15 False False) OrderByProperty Bezier True False { key = Nothing }
    , storage = ProjectStorage.Local
    , visibility = ProjectVisibility.None
    , version = ProjectEncodingVersion.current
    , createdAt = time 1000
...
project2 =
    ...
    , tableRowsSeq = 1
    , settings = ProjectSettings (FindPathSettings 4 "users" "created_by") defaultSchema [] False "" (HiddenColumns "created_.+, updated_.+" 15 False False) OrderByProperty Bezier True False { key = Nothing }
    , storage = ProjectStorage.Local
    , visibility = ProjectVisibility.None
    , version = ProjectEncodingVersion.current
    , createdAt = time 1000
