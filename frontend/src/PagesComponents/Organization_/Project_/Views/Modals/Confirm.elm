module PagesComponents.Organization_.Project_.Views.Modals.Confirm exposing (viewConfirm)

import Components.Molecules.Modal as Modal
import Html exposing (Html)
import PagesComponents.Organization_.Project_.Models exposing (ConfirmDialog, Msg(..))
