module PagesComponents.Organization_.Project_.Views.Modals.Prompt exposing (viewPrompt)

import Components.Molecules.Modal as Modal
import Html exposing (Html)
import PagesComponents.Organization_.Project_.Models exposing (Msg(..), PromptDialog)
