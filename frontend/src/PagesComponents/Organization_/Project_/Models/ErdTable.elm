module PagesComponents.Organization_.Project_.Models.ErdTable exposing (ErdTable, create, getColumnI, getColumnRoot, getTable, inChecks, inIndexes, inPrimaryKey, inUniques, rank, unpack)
