...
update req now projects urlOrganization msg model =
    case msg of
        ...
        CreateEmptyProject name ->
            ( model, SourceId.generator |> Random.generate (Source.empty Conf.constants.defaultSourceName now >> Project.create urlOrganization projects name >> CreateProjectTmp) )
