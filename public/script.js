window.addEventListener('load', function() {
    ...
    customElements.define('az-editor', class extends HTMLElement {
        constructor() {
            ...
            shadowRoot.innerHTML = `<div id="monaco-editor" style="width: 800px; height: 600px; border: 1px solid grey; position: relative"></div>`
            require.config({ paths: { vs: '/assets/monaco-editor/dev/vs' } })
            require(['vs/editor/editor.main'], function () {
                var editor = monaco.editor.create(
                    shadowRoot.getElementById('monaco-editor'),
